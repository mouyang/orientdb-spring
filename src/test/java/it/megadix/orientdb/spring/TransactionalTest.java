...
public class TransactionalTest {
    ...
    static class ContextConfiguration {
        ...
        @Bean
        TransactionalTestService myTransactionalService() {
    ...
    public void test_concurrent_write_read() throws Exception {
        ...
        Future<?> future_A = executorService.submit(new Runnable() {
            @Override
            public void run() {
                service.test_A(barrier, TransactionalTest.this);
            }
        });
        ...
        Future<?> future_B = executorService.submit(new Runnable() {
            @Override
            public void run() {
                service.test_B(barrier, TransactionalTest.this);
            }
        });
    ...
    public static void main(String[] args) {
        ...
        ctx.scan(TransactionalTest.class.getPackage().getName());

        TransactionalTest test = new TransactionalTest();
        test.service = ctx.getBean(TransactionalTestService.class);
